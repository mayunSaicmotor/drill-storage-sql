...
import org.apache.drill.exec.store.http.util.ConstantsUtil;
...
class JdbcRecordReader extends AbstractRecordReader {
  ...
  public void setup(OperatorContext operatorContext, OutputMutator output) throws ExecutionSetupException {
    try {
      ...
      logger.info("start to execute SQL at: "+ System.nanoTime());
  ...
  public int next() {
    ...
    try {
    	//TODO
      while (counter < ConstantsUtil.INITIAL_VALUE_ALLOCATION && b == true) { // loop at 4095 since nullables use one more than record count and we

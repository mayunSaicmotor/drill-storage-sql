...
public class NodeProcessUtil {
	...
	public static Map<Integer, OrderByColumn> getOrderByColsMap(final Prel sort) {
		...
		return getOrderByColsMap(collationList, sort.getRowType().getFieldList());
	}


	public static Map<Integer, OrderByColumn> getOrderByColsMap(final List<RelCollation> collationList, List<RelDataTypeField> fieldList) {
		//TopNPrel sortP =(TopNPrel)sort;
		...
		/*		relFieldCollation.getFieldIndex();
				...
				orderByColMap.put(relFieldCollation.getFieldIndex(),
						new OrderByColumn(
								fieldList.get(relFieldCollation.getFieldIndex()).getName(),

...
public class PushDownFilterToScan extends StoragePluginOptimizerRule {
  private static final Logger logger = LoggerFactory .getLogger(PushDownFilterToScan.class);
  public static final StoragePluginOptimizerRule INSTANCE = new PushDownFilterToScan();

  private PushDownFilterToScan() {
